...
type EmployeeServiceClient interface {
	AddEmployee(ctx context.Context, in *Employee, opts ...grpc.CallOption) (*EmployeeReply, error)
}
...
func (c *employeeServiceClient) AddEmployee(ctx context.Context, in *Employee, opts ...grpc.CallOption) (*EmployeeReply, error) {
...
type EmployeeServiceServer interface {
	AddEmployee(context.Context, *Employee) (*EmployeeReply, error)
...
func (UnimplementedEmployeeServiceServer) AddEmployee(context.Context, *Employee) (*EmployeeReply, error) {
...
func _EmployeeService_AddEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).AddEmployee(ctx, req.(*Employee))
	}
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api-gateway/pkg/clients/employee/proto/employee.proto",
}
